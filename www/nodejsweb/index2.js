...
.createServer(function (req, res) {
  if (req.url !== '/favicon.ico') {
    ...
    console.log('goods_id:' + params.goods_id + ' num:' + params.num + ' pay_type:' + params.pay_type + ' user_id:' + params.user_id + ' AccessToken:' + params.AccessToken + ' proxyUrl:' + params.proxyUrl)
    ;(async function () {
      res.writeHeader(200, {
...
const get_data = async (
  ...
  const browser = await puppeteer.launch({
    ...
    //executablePath:
    // 'C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe', //path to your chrome
